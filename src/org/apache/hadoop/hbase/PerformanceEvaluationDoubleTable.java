 ...
 */
public class PerformanceEvaluationDoubleTable implements HConstants {
  protected static final Log LOG = LogFactory.getLog(PerformanceEvaluationDoubleTable.class.getName());
  ...
  public static final byte [] FAMILY_NAME_AND_QUALIFIER_NAME_DATA=Bytes.toBytes("info:data");
public static final byte [] FAMILY_NAME_AND_QUALIFIER_NAME=Bytes.toBytes("info:index");
   ...
   */
  public PerformanceEvaluationDoubleTable(final HBaseConfiguration c) {
    this.conf = c;
  }
  ...
  public static class EvaluationMapTask 
    ...
    private String cmd;
    private PerformanceEvaluationDoubleTable pe;
    
    
    protected void setup(Context context) throws IOException, InterruptedException {
    	this.cmd = context.getConfiguration().get(CMD_KEY);
    	this.pe = new PerformanceEvaluationDoubleTable(new HBaseConfiguration(context.getConfiguration()));
    }
  ...
  private void doMapReduce(final String cmd) throws IOException, 
    ...
    job.setJarByClass(PerformanceEvaluationDoubleTable.class);
  ...
  class RandomWriteTest extends Test {
    ...
    void testRow(final int i) throws IOException {
      ...
      Put put = new Put(row);
      put.add(FAMILY_NAME, QUALIFIER_NAME,format(this.rand.nextLong()));
  ...
  public static void main(final String[] args) {
    ...
    System.exit(new PerformanceEvaluationDoubleTable(c).doCommandLine(args));
  }
}
