...
public class IndexSpecification implements Writable {
   ...
   * @param indexedColumn
   */
  public IndexSpecification(String indexId, byte[] indexedColumn,String baseTableName) {
    
	  this(indexId, new byte[][] { indexedColumn }, null,
        new SimpleIndexKeyGenerator(indexedColumn),baseTableName);
  ...
  public IndexSpecification(String indexId, byte[][] indexedColumns,
      byte[][] additionalColumns, IndexKeyGenerator keyGenerator ,String baseTableName) {
  ...
  public boolean equals(Object arg0)
  	{
	  	if(arg0 instanceof IndexSpecification)
	  	{
	  		...
	  		if(index.getBaseTableName()==null)
	  		{
	  			
	  			if(index.indexId.equals(this.indexId))
	  				return true;
	  		}
	  			if(index.indexId.equals(this.indexId)&&this.baseTableName.equals(index.getBaseTableName()))
	  				return true;
	  	}
	  	return false;
  	}	
