...
class ServerManager implements HConstants {
  ...
  public double getAverageLoad() {
    ...
    synchronized (serversToLoad) {
      ...
      for(String ser:serversToLoad.keySet())
      		{
    	  		LOG.debug("!!!!!!!!!!!!!!!!!!!!!!!!server "+ser+" load is"+serversToLoad.get(ser).getNumberOfRegions());
    	  totalLoad += serversToLoad.get(ser).getNumberOfRegions();
      		}
