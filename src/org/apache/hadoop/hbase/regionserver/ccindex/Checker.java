...
public class Checker extends Thread {
	...
	public Checker(HBaseConfiguration conf, byte[] targetTableName,
			IndexedTableDescriptor des, HRegionServer server) {
	...
	public void init() {
		...
		for (IndexSpecification index : des.getIndexes()) {
			byte[] name = index.getIndexedTableName(base);
	...
	public void run() {
		...
		try {
			...
			table = new HTable(conf, Bytes.add(this.targetTableName,
					CCIndexAdmin.CCT_TAIL));
